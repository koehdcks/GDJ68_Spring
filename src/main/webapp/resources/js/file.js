...
//jquery 로 작성한거 (사진첨부 추가)
$('#addFile').click(function(){
    let f = '<div class="mb-5">';
    f = f+'<label for="formPic" class="form-label">사진첨부</label><input type="file" name="photos" id="formPic">';
    f = f+'<span class="df">X</span></div>';
    if(count>=max){
        alert("파일은 5개가 최대");
        return;
    }
